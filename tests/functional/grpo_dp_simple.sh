#!/bin/bash
# Lightweight e2e for grpo_sync.py — TQ pipeline with the in-Ray "simple"
# backend. Same shape as tests/functional/grpo.sh (Qwen3-0.6B, 2 GPUs,
# 2 steps); flipping data_plane.enabled=true routes examples/run_grpo.py
# to nemo_rl.algorithms.grpo_sync.grpo_train_sync.
